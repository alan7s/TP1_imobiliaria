   ...
   <!--<img src="imagem-fundo.jpg" id="imagem" alt="">-->
    <form class="containers col-lg-4" method="POST" action="processa.php" onsubmit="salvar()">
         ...
         <div class="form-group">
            ...
            <select class="form-control " id="opcao" onChange="selectopcao()">
                <option selected disabled hidden style='display: none' value=''></option> 
                <option  value="cadatro">Cadastrar imóvel</option>
            ...
            <div id="visualizar" style="display:block" class="form-group"> 
            </div>
             <script>
