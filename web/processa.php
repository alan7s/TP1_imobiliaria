...
if ($opcao =='cadastro')
{
	...
	$salas2 = filter_input(INPUT_POST, 'salas', FILTER_SANITIZE_NUMBER_INT);
	...
	$result_usuario = "INSERT INTO imobiliaria (tipoImovel,quartos, suites, vagas, area,armario, rua, numero, complemento,bairro, aluguel, data, hora, mensagem,salas2,andar,condominio,portaria) VALUES ('$tipoImovel','$quartos', '$suites','$vagas', '$area','$armario','$rua','$numero','$complemento','$bairro','$aluguel','$data','$hora','$mensagem','$salas2','$andar','$condominio','$portaria')";
		...
		$salas2 = filter_input(INPUT_POST, 'salas', FILTER_SANITIZE_NUMBER_INT);
		$result_usuario = "INSERT INTO imobiliaria (tipoImovel,quartos, suites, vagas, area,armario, rua, numero, complemento,bairro, aluguel, data, hora, mensagem,salas2,andar,condominio,portaria) VALUES ('$tipoImovel','$quartos', '$suites','$vagas', '$area','$armario','$rua','$numero','$complemento','$bairro','$aluguel','$data','$hora','$mensagem','$salas2','0','0','N')";
	}
